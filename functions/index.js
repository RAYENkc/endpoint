...
var assignmentApi = require('./assignment');
module.exports = assignmentApi;

var notifApi = require('./notification');
module.exports = notifApi;

var nodifProspect = require('./prospect_notification');
module.exports = nodifProspect ;
...
var authapi = require('./authontication');
module.exports = authapi;

var nodif  = require('./pushnotif');
module.exports = nodif ;
